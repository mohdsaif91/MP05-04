...
<html lang="en">
                            ...
                            <div class="row">
                                <div class="col-md-4 order-md-2 mb-4">
                                    ...
                                    <c:forEach items="${productdetials}" var="lp">
                                        ...
                                        <div>Discount is given above <lp id="discountprice">${discountprice}</lp>$</div>
                                        <div class="card p-2">
                                            ...
                                            <b id="discountmsg">You are not eligible for Discount </b>
                                        </div>
                                    </c:forEach>
                            ...
                            <div class="row">
                                ...
                                <div class="col-3 col-sm-3">
                                    <label class="select" id="displaypaypal">
                                        ...
                                        <img class="img-thumbnail" src="https://matrixpharmacy.s3.amazonaws.com/productimage/icons8-paypal-64.png">
                                ...
                                <div class="col-3 col-sm-3">
                                    <label class="select" id="displaygpay">
                                        ...
                                        <img class="img-thumbnail" src="https://matrixpharmacy.s3.amazonaws.com/productimage/icons8-google-pay-64.png">
                                ...
                                <div class="col-3 col-sm-3" id="displayzelle">
                                    <label class="select">
                                        ...
                                        <img style="height:80px;width: 80px;" class="img-thumbnail" src="https://matrixpharmacy.s3.amazonaws.com/productimage/3571631-com.minny.zellpay.png">
                                        <center>Zelle</center>
                                    </label>
                                </div>
                                <div class="col-3 col-sm-3">
                                    <label class="select" id="displaycreditcard">
                                        ...
                                        <img class="img-thumbnail" src="https://matrixpharmacy.s3.amazonaws.com/productimage/icons8-credit-card-64.png">
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            var dsicountprice = $('#discountprice').text();
            var actualprice = $("#jkl").text();
            var num1 = new Float32Array(actualprice);
            var num2 = new Float32Array(dsicountprice);
            if (num1 <= num2) {
                document.getElementById("getdiscount").disabled = true;
                document.getElementById("redemcode").disabled = true;
                $('#discountmsg').show();
            } else {
                document.getElementById("getdiscount").disabled = false;
                document.getElementById("redemcode").disabled = false;
