                        ...
                        <c:forEach items="${productvalue}" var="op">
                            <div class="col-md-5 mr-auto">
                                <div class="border text-center">
                                    <img src="https://matrixpharmacy.s3.amazonaws.com/productimage/${op.imagename}" alt="Image" class="img-fluid p-5">
                                </div>
                            </div>
                            <div class="col-md-6">
                                ...
                                <div class="mb-5">
                                    ...
                                    <b class="text-black" id="pricemsg">
                                        Purchasing Price should be greater or Equal to 35 $
                                    </b>
                                    <br>
                                ...
                                <div class="row" >
                                    <div class="col-lg-4 col-sm-4">
                                        <p><Button href="#" class="buy-now btn btn-sm height-auto px-4 py-3 btn-danger max-auto buy-nowo" id="btnbuy" style="padding-left: 15px">Buy Now</a></Button>
                                    </div>
                                    <div class="col-lg-4 col-sm-4">
