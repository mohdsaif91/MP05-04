    ...
    <body>
                    ...
                    <div class="row mt-4" id="inithide">
                        <div class="col-md-5 mr-auto">
                            <div class="border text-center">
                                <img id="imagecate" src="https://matrixpharmacy916.s3.us-east-1.amazonaws.com/" alt="Image" class="img-fluid p-5">
                            </div>
                        </div>
                        <div class="col-md-6">
                            ...
                            <div class="mb-5">
                                <div class="input-group mb-3" style="max-width: 220px;">
                                    <div class="input-group-prepend">
                                        <button class="btn btn-outline-info js-btn-minus" id="pminus" type="button">&minus;</button>
                                    </div>
                                    <input type="text" name="quantity" class="form-control text-center" id="quantity" value="1" placeholder=""
                                           aria-label="Example text with button addon" aria-describedby="button-addon1">
                                    <div class="input-group-append">
                                        <button class="btn btn-outline-info js-btn-plus" id="pplus" type="button">&plus;</button>
                                    </div>
                                    <br>
                                    <b class="text-black" id="pricemsg">
                                        Purchasing Price should be greater or Equal to ${price} $
                                    </b>
                                    <br>
                                    <b>Total:-<op id="totalprice"></op></b>
                                </div>
                            </div>
                            <div class="mt-5">
                    ...
                    <div class="row" id="hidecategory">
                        <c:forEach items="${allvalue}" var="lp">
                            <div  class="col-lg-4 col-sm-10 col-md-6  m-l-r-auto text-center ">
                                ...
                                <a href="#"><img src="https://matrixpharmacy.s3.amazonaws.com/companyImage/${lp.companyImageName}" alt="Image"></a>
                            ...
                            <div class="nonloop-block-3 owl-carousel">
                                <c:forEach items="${allvalue}" var="lp">
                                    <div class="text-center item mb-4">
                                        <a href="shop-single.html"> <img src="https://matrixpharmacy916.s3.us-east-1.amazonaws.com//${lp.companyImageName}" alt="Image"></a>
        ...
        <script>
                                                    ...
                                                    $.get('getSingleProduct', {
                                                        ...
                                                        if (responsivetext !== 'No Product Found !') {
                                                            $.each(responsivetext, function (key, value) {
                                                                ...
                                                                $('#imagecate').attr('src', 'https://matrixpharamacy916.s3.amazonaws.com/' + value.imagename);
                                                    ...
                                                    $.get('getSingleProduct', {
                                                        ...
                                                        if (responsivetext !== 'No Product Found !') {
                                                            $.each(responsivetext, function (key, value) {
                                                                ...
                                                                $('#brandname').text(value.brandname);
                                                                $('#tabename').text(value.company);
                                                                $('#imagecate').attr('src', 'https://marixpharmacyking.s3.amazonaws.com/' + value.imagename);
                                                                $('#productprice').text(value.productprice);
                                                                $('#packagig').text(value.packaging);
                                                                $('#genericname').text(value.genericname);
                                                                $('#medeidescription').text(value.productdescription);
                                    ...
                                    document.getElementById("pminus").addEventListener("click", function () {
                                        ...
                                        var qun = $('#quantity').val();
                                        var productPrice = qun * price;
                                        var ogprice = parseFloat(productPrice).toFixed(2);
                                        document.getElementById("totalprice").innerHTML = ogprice;
                                        if (productPrice >= 35) {
                                            document.getElementById('buynowdis').disabled = false;
                                        } else {
                                            document.getElementById('buynowdis').disabled = true;
